...
//import uk.gov.hmrc.eventhub.config.{PublisherConfig, Subscriber, Topic}
...
//          publishedEventAuditor,
//          publisherConfig,
//          mongoComponent,
//          eventRepository,
//          subscriberQueuesRepository,
//          mongoSetup
//        )
//
...
//  class TestCase {
//    val retries = 5
//    val publishedEventAuditor: PublishEventAuditor = mock[PublishEventAuditor]
//    val publisherConfig: PublisherConfig = PublisherConfig(transactionRetries = retries)
