...
object Dependencies {
  ...
  object Library {
    ...
    val Swagger = "org.webjars"                  % "swagger-ui"                        % "5.1.0"
    val Enumeration = "com.beachape"            %% "enumeratum-play"                   % "1.7.2"
    val MongoScalaDriver = "org.mongodb.scala"  %% "mongo-scala-driver"                % "4.10.1"
    val jayway = "com.jayway.jsonpath"           % "json-path"                         % "2.8.0"
    val BootstrapTest = "uk.gov.hmrc"           %% "bootstrap-test-play-28"            % "7.19.0"
    ...
    val ServiceIntegrationTest = "uk.gov.hmrc"  %% "service-integration-test"          % "1.3.0-play-28"
