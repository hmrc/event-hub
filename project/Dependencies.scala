...
object Dependencies {
  ...
  object Library {
    ...
    val HmrcMongo = "uk.gov.hmrc.mongo"         %% "hmrc-mongo-play-28"                % "0.53.0"
    val HmrcMongoWorkItem = "uk.gov.hmrc.mongo" %% "hmrc-mongo-work-item-repo-play-28" % "0.53.0"
    ...
    val HmrcMongoTest = "uk.gov.hmrc.mongo"     %% "hmrc-mongo-test-play-28"           % "0.53.0"
    ...
    val Mockito = "org.mockito"                 %% "mockito-scala"                     % "1.16.39"
